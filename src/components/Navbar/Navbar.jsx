        ...
        <nav className="navbar">
                            ...
                            <div className="cart-dropdown">
                                <Cart
                                    ...
                                    onRemove={(item) =>
                                        setCartItems((prev) =>
                                            prev.map((p) =>
                                                p.id === item.id ? {...p, quantity: Math.max(p.quantity - 1, 1)} : p
                                            )
                                        )
                                    }
                                    onDelete={(item) => setCartItems((prev) => prev.filter((p) => p.id !== item.id))}
                                />
                            </div>
                        )}
                    </div>
            ...
            <div className={`mobile-menu ${isMobileMenuOpen ? "open" : ""}`}>
                <ul className="mobile-nav-links">
                    ...
                    {/* Mobile dropdown */}
                    <Dropdown scrollToId={scrollToId} isMobileOpen={isProductsDropdownOpen} />
